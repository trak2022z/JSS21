const FETCH_SHOP_ID_DELAY = 2000;
const FETCH_PIZZA_DETAILS_DELAY = 2500;
const FETCH_BEVERAGES_DETAILS_DELAY = 2000;
const CREATE_ORDER_DELAY = 3000;
...
function orderPizza(type, name) {
  ...
  fetch("/api/pizzahub/shop", {'long': 21.999121 , 'lat': 50.041187})
